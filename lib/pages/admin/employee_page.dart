            ...
            content: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    height:
                        200, // Fixed height for permissions list with scroll
  ...
  Future<void> _confirmDeletion(Map<String, dynamic> emp) async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AsriDialog(
        ...
        message:
            "Apakah Anda yakin ingin menghapus '${emp['fullName']}'? Akses login karyawan ini akan segera dicabut.",
